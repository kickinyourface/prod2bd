...
class CategoriaControllerTest < ActionController::TestCase
  ...
  test "should create categorium" do
    assert_difference('Categorium.count') do
      post :create, categorium: { cod_categoria: @categorium.cod_categoria, nom_categoria: @categorium.nom_categoria }
    end
  ...
  test "should update categorium" do
    patch :update, id: @categorium, categorium: { cod_categoria: @categorium.cod_categoria, nom_categoria: @categorium.nom_categoria }
    assert_redirected_to categorium_path(assigns(:categorium))
  end
