...
class TipoDocumentosControllerTest < ActionController::TestCase
  ...
  test "should create tipo_documento" do
    assert_difference('TipoDocumento.count') do
      post :create, tipo_documento: { cod_tipodoc: @tipo_documento.cod_tipodoc, formato: @tipo_documento.formato, nom_tipdoc: @tipo_documento.nom_tipdoc }
    end
  ...
  test "should update tipo_documento" do
    patch :update, id: @tipo_documento, tipo_documento: { cod_tipodoc: @tipo_documento.cod_tipodoc, formato: @tipo_documento.formato, nom_tipdoc: @tipo_documento.nom_tipdoc }
    assert_redirected_to tipo_documento_path(assigns(:tipo_documento))
  end
