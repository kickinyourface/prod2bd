...
class ProductosControllerTest < ActionController::TestCase
  ...
  test "should create producto" do
    assert_difference('Producto.count') do
      post :create, producto: { cantidad: @producto.cantidad, cod_producto: @producto.cod_producto, nom_producto: @producto.nom_producto, precio_unit: @producto.precio_unit }
    end
  ...
  test "should update producto" do
    patch :update, id: @producto, producto: { cantidad: @producto.cantidad, cod_producto: @producto.cod_producto, nom_producto: @producto.nom_producto, precio_unit: @producto.precio_unit }
    assert_redirected_to producto_path(assigns(:producto))
  end
